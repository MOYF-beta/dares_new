...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N train_vivit_pose_encoder
#$ -o /cluster/project7/Llava_2024/changhao/dares_new/logs/train_vivit_pose_encoder.log
#$ -e /cluster/project7/Llava_2024/changhao/dares_new/logs/train_vivit_pose_encoder.err
...
python /cluster/project7/Llava_2024/changhao/dares_new/exps/vivit_pose_encoder/train_vivit_pose_encoder.py

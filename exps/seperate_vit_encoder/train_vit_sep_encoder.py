...
from exps.seperate_vit_encoder.trainer_vit_encoder import TrainerVitEncoder
from exps.seperate_vit_encoder.options_vit_encoder import VitEndoderOpt
...
opt = VitEndoderOpt
model_name = get_unique_name('dares_seperate_vit_encoder')

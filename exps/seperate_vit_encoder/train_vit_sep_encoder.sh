...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N train_vit_sep_encoder
#$ -o /cluster/project7/Llava_2024/changhao/dares_new/logs/train_vit_sep_encoder.log
#$ -e /cluster/project7/Llava_2024/changhao/dares_new/logs/train_vit_sep_encoder.err
...
python /cluster/project7/Llava_2024/changhao/dares_new/exps/seperate_vit_encoder/train_vit_sep_encoder.py

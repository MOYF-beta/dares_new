...
from exps.attn_encoder_dora_base_model_full_no_shuffle.trainer_attn_encoder import TrainerAttnEncoder
from exps.attn_encoder_dora_base_model_full_no_shuffle.options_attn_encoder import AttnEncoderOpt
...
opt = AttnEncoderOpt
model_name = 'base_model_full_1_no_shuffle'
...
if __name__ == "__main__":
    if not check_test_only():
        trainer = TrainerAttnEncoder(model_name, log_path, opt, 
                          train_eval_ds={'train': ds_base_model_train, 'val': ds_val,'train_sampler':ConcatDatasetSampler },

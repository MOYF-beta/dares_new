...
from exps.exp_setup_local import (ds_val, check_test_only, get_unique_name, log_path,  ds_train, ds_train_hamlyn,
                                  ds_base_model_train, 
...
if __name__ == "__main__":
    ...
    #                       train_eval_ds={'train': ds_train_hamlyn, 'val': ds_val},

...
#$ -pe gpu 1
#$ -N train_baseline
#$ -o /cluster/project7/Llava_2024/changhao/dares_new/logs/train_baseline.log
#$ -e /cluster/project7/Llava_2024/changhao/dares_new/logs/train_baseline.err
...
python /cluster/project7/Llava_2024/changhao/dares_new/exps/baseline/train_baseline.py

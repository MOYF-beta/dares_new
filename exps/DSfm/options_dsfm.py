"""
Options for DSFM (Direct Structure from Motion) trainer
"""
...
DefaultOpt_dict = {
        ...
        # DSFM specific options
        "self_ssi": True,  # Disable self-supervised improvement for initial experiments
        "warm_up_step": 5,  # Warmup steps if self_ssi is enabled
...
DSFMOpt = DotDict(DefaultOpt_dict)

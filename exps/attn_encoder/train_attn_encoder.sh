...
#$ -l gpu_type=a6000
#$ -pe gpu 1
#$ -N train_attn_encoder
#$ -o /cluster/project7/Llava_2024/changhao/dares_new/logs/train_attn_encoder.log
#$ -e /cluster/project7/Llava_2024/changhao/dares_new/logs/train_attn_encoder.err
...
python /cluster/project7/Llava_2024/changhao/dares_new/exps/attn_encoder/train_attn_encoder.py
